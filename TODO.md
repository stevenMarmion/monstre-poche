...
- Refactoring controllers --> à refactoriser --> BatlleController et OnlineGameController -- fait
- Refactoring views -- fait
- Note spéciale pour showBattleOnline qui pue sa mère, à refaire, on doit faire comme le reste des vues, c-a-dire on met dans le constructeur un controller (voir monstrePocheUI.java)-- fait
- Regénérer fichier attacks et monsters avec les vrais pokémons -- fait
- Régler bug interface changement type de monstre quand on switch, le type ne change pas -- en cours
