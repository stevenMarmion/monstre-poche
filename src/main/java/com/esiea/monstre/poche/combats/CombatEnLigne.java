...
public class CombatEnLigne extends Combat {
    ...
    private void envoyerEtatAuxJoueurs() {
        Monstre mLocal = joueur1.getMonstreActuel();
        Monstre mDistant = joueur2.getMonstreActuel();
        String etatLocal = joueur1.getNomJoueur() + " -> " + mLocal.getNomMonstre() + " | PV " + (int) mLocal.getPointsDeVie() + "/" + (int) mLocal.getPointsDeVieMax();
        String etatDistant = joueur2.getNomJoueur() + " -> " + mDistant.getNomMonstre() + " | PV " + (int) mDistant.getPointsDeVie() + "/" + (int) mDistant.getPointsDeVieMax();
        broadcast(etatLocal);
