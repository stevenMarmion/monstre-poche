...
import com.esiea.monstre.poche.chore.models.combats.Combat;
...
import com.esiea.monstre.poche.chore.models.online.OnlineClient;
import com.esiea.monstre.poche.chore.models.online.OnlineConnection;
import com.esiea.monstre.poche.chore.models.online.OnlineServer;
...
public class OnlineGameController {
    ...
    // Loaders pour reconstruire les monstres/attaques distants
    ...
    public OnlineGameController(OnlineGameView view, INavigationCallback navigationCallback) {
        ...
        // Charger les ressources pour pouvoir reconstruire les entites distantes
        try {
            this.monstreLoader = new MonstreLoader("monsters.txt");
            this.monstreLoader.charger();
            this.attaqueLoader = new AttaqueLoader("attacks.txt");
            this.attaqueLoader.charger();
            CombatLogger.logReseau("Ressources chargees: " + monstreLoader.getNombreRessources() + " monstres, " + attaqueLoader.getNombreRessources() + " attaques");
        } catch (Exception e) {
            CombatLogger.error("Erreur de chargement des ressources : " + e.getMessage());
        }
    ...
    private Monstre findMonstreByName(String name) {
        if (monstreLoader == null) return null;
        for (Monstre m : monstreLoader.getRessources()) {
    ...
    private Attaque findAttaqueByName(String name) {
        if (attaqueLoader == null) return null;
        for (Attaque a : attaqueLoader.getRessources()) {
