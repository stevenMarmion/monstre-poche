...
import com.esiea.monstre.poche.models.items.medicaments.MedicamentAntiPoison;
import com.esiea.monstre.poche.models.items.potions.PotionDegat;
import com.esiea.monstre.poche.models.items.potions.PotionSante;
                ...
                switch (ligne) {
                    ...
                    default:
                        ...
                        switch (cle) {
                            ...
                            case "Type":
                                type = TypeUtils.getTypeFromString(parts[1]);
                                break;
                    ...
                    default:
                        ...
                        switch (cle) {
                            case "Name":
                                ...
                                break;
                            case "Type":
                                type = TypeUtils.getTypeFromString(valeur);
                                break;
                            case "Power":
